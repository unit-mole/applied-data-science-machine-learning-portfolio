...
| 7 | [Retrospective Election Survey Classification](projects/07-election-exit-poll-prediction/) | Historical binary classification | 1,525 historical survey rows with vote, age, leader ratings, economic assessments, Europe attitudes, knowledge, and gender. | The calibrated random forest reaches retrospective test ROC-AUC 0.909 and balanced accuracy 0.806; this is respondent classification, not polling. | Understand classification signal and uncertainty without making live-election claims. |
