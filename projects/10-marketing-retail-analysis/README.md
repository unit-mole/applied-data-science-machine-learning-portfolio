...
- Re-engineered a restaurant point-of-sale analytics analysis into a reproducible transactional business analysis and item segmentation workflow with automated data-quality evidence, saved outputs, and a fully executed recruiter-facing notebook.
- Implemented duplicate control and problem-appropriate validation to produce the verified result: The cleaned year contains 69,982 bills and 32,654,640 recorded revenue units; two stable menu-item groups score 0.395 silhouette.
